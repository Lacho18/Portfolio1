...
const projectsData = [
    ...
    },
    {
        ...
        name: "To do list",
        images: [],
        description: `This app is build with NodeJS and Express.js. It represents a task list, where the user can add his task and to mark their importance. The app has features like 
                       to skip task and to see all skipped task, to see all completed task and to add and remove task from the list.`,
        gitHubLink: "https://github.com/Lacho18/ToDoListNodeJS"
    },
];
